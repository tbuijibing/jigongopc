...
import { GOAL_STATUSES, GOAL_LEVELS } from "@Jigongai/shared";
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("goals.newDialog.subGoalTitle") : t("goals.newDialog.title")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("goals.newDialog.titlePlaceholder")}
            value={title}
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("goals.newDialog.addDescription")}
            bordered={false}
          ...
          <Popover open={levelOpen} onOpenChange={setLevelOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {t(`goals.newDialog.level.${level}`, { defaultValue: level })}
              </button>
            </PopoverTrigger>
            <PopoverContent className="w-40 p-1" align="start">
              {GOAL_LEVELS.map((l) => (
                ...
                >
                  {t(`goals.newDialog.level.${l}`, { defaultValue: l })}
                </button>
              ))}
            </PopoverContent>
          </Popover>
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("goals.newDialog.parentGoal")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("goals.newDialog.creating") : newGoalDefaults.parentId ? t("goals.newDialog.createSubGoal") : t("goals.newDialog.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
