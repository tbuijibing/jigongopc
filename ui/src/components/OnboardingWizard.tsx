...
import type { AdapterEnvironmentTestResult } from "@Jigongai/shared";
...
const DEFAULT_TASK_DESCRIPTION = `Setup yourself as the CEO. Use the ceo persona found here: [https://github.com/Jigongai/companies/blob/main/default/ceo/AGENTS.md](https://github.com/Jigongai/companies/blob/main/default/ceo/AGENTS.md)
...
export function OnboardingWizard() {
  ...
  async function runAdapterEnvironmentTest(
    ...
    if (!createdCompanyId) {
      setAdapterEnvError(
        t("onboarding.errors.createCompanyFirst")
      );
      return null;
    }
  ...
  async function handleStep1Next() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t("onboarding.errors.failedCreateCompany"));
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleStep2Next() {
    ...
    try {
      if (adapterType === "opencode_local") {
        ...
        if (!selectedModelId) {
          setError(t("onboarding.errors.openCodeModelRequired"));
          return;
        }
        if (adapterModelsError) {
          setError(
            adapterModelsError instanceof Error
              ...
              : t("onboarding.errors.openCodeModelsFailed"),
          );
          return;
        }
        if (adapterModelsLoading || adapterModelsFetching) {
          setError(t("onboarding.errors.openCodeModelsLoading"));
          return;
        }
      ...
      setError(err instanceof Error ? err.message : t("onboarding.errors.failedCreateAgent"));
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleUnsetAnthropicApiKey() {
    ...
    try {
      ...
      if (result?.status === "fail") {
        setError(
          t("onboarding.errors.retryAnthropicFailed")
        );
      }
    } catch (err) {
      setError(
          ...
          ? err.message
          : t("onboarding.errors.unsetAnthropicFailed")
      );
    } finally {
      setUnsetAnthropicLoading(false);
    }
  ...
  async function handleStep3Next() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : t("onboarding.errors.failedCreateTask"));
    } finally {
      setLoading(false);
    }
  }
            ...
            <div className="w-full max-w-md mx-auto my-auto px-8 py-12 shrink-0">
              ...
              {step === 1 && (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t("onboarding.step1.missionLabel")}
                    </label>
                    <textarea
              ...
              {step === 2 && (
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                      placeholder={t("onboarding.step2.agentNamePlaceholder")}
                      value={agentName}
                      ...
                      {[
                        {
                          ...
                          label: "Claude Code",
                          icon: Sparkles,
                          desc: t("onboarding.step2.descClaudeLocal"),
                          recommended: true
                        },
                        {
                          ...
                          label: "Codex",
                          icon: Code,
                          desc: t("onboarding.step2.descCodexLocal"),
                          recommended: true
                        },
                        {
                          ...
                          desc: t("onboarding.step2.descOpenCodeLocal")
                        },
                        {
                          value: "pi_local" as const,
                          label: "Pi",
                          icon: Terminal,
                          desc: t("onboarding.step2.descPiLocal")
                        },
                        {
                          value: "openclaw_gateway" as const,
                          label: "OpenClaw Gateway",
                          icon: Bot,
                          desc: t("onboarding.step2.descOpenClawGateway")
                        },
                        {
                          value: "cursor" as const,
                          label: "Cursor",
                          icon: MousePointer2,
                          desc: t("onboarding.step2.descCursor")
                        }
                      ].map((opt) => (
                        <button
                          key={opt.value}
                      ...
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          <label className="text-xs text-muted-foreground">
                            {t("onboarding.step2.workingDirectory")}
                          </label>
                          <HintIcon text={t("onboarding.step2.workingDirectoryHint")} />
                        </div>
                        <div className="flex items-center gap-2 rounded-md border border-border px-2.5 py-1.5">
                          ...
                          <input
                            ...
                            placeholder={t("onboarding.step2.workingDirectoryPlaceholder")}
                            value={cwd}
                        ...
                        >
                            ...
                            <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2.5 py-1.5 text-sm hover:bg-accent/50 transition-colors w-full justify-between">
                              ...
                              >
                                {selectedModel
                                  ...
                                  : model ||
                                    (adapterType === "opencode_local"
                                      ? t("onboarding.step2.selectModelRequired")
                                      : t("onboarding.step2.default"))}
                              </span>
                          ...
                          >
                            <input
                              ...
                              placeholder={t("onboarding.step2.searchModels")}
                              value={modelSearch}
                            ...
                            {filteredModels.length === 0 && (
                              <p className="px-2 py-1.5 text-xs text-muted-foreground">
                                {t("onboarding.step2.noModelsDiscovered")}
                              </p>
                            )}
                          </PopoverContent>
                        </Popover>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        <div>
                          <p className="text-xs font-medium">
                            {t("onboarding.step2.adapterEnvCheck")}
                          </p>
                          <p className="text-[11px] text-muted-foreground">
                            {t("onboarding.step2.adapterEnvCheckDesc")}
                          </p>
                        </div>
                        <Button
                          size="sm"
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            {t("onboarding.step2.anthropicKeyWarning", { key: "ANTHROPIC_API_KEY" })}
                          </p>
                          <Button
                            size="sm"
                            variant="outline"
                          ...
                          >
                            {unsetAnthropicLoading ? t("onboarding.step2.retrying") : t("onboarding.step2.unsetAnthropicKey")}
                          </Button>
                        </div>
                      )}

                      <div className="rounded-md border border-border/70 bg-muted/20 px-2.5 py-2 text-[11px] space-y-1.5">
                        <p className="font-medium">{t("onboarding.step2.manualDebug")}</p>
                        ...
                        <p className="text-muted-foreground">
                          {t("onboarding.step2.prompt")}{" "}
                          <span className="font-mono">{t("onboarding.step2.respondWithHello")}</span>
                        </p>
                        {adapterType === "cursor" || adapterType === "codex_local" || adapterType === "opencode_local" ? (
                          <p className="text-muted-foreground">
                            {t("onboarding.step2.authFailSet")}{" "}
                            <span className="font-mono">
                              {adapterType === "cursor" ? "CURSOR_API_KEY" : "OPENAI_API_KEY"}
                            </span>{" "}
                            {t("onboarding.step2.inEnvOrRun")}{" "}
                            <span className="font-mono">
                              {adapterType === "cursor"
                                ? "agent login"
                                : adapterType === "codex_local"
                          ...
                          <p className="text-muted-foreground">
                            {t("onboarding.step2.loginRequired")}{" "}
                            <span className="font-mono">claude login</span>{" "}
                            {t("onboarding.step2.andRetry")}
                          </p>
                        )}
                      </div>
                    </div>
                  ...
                  {adapterType === "process" && (
                    <div className="space-y-3">
                      <div>
                        <label className="text-xs text-muted-foreground mb-1 block">
                          {t("onboarding.step2.command")}
                        </label>
                        <input
                          className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm font-mono outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                          placeholder={t("onboarding.step2.commandPlaceholder")}
                          value={command}
                      ...
                      <div>
                        <label className="text-xs text-muted-foreground mb-1 block">
                          {t("onboarding.step2.argsLabel")}
                        </label>
                        <input
                          className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm font-mono outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
                          placeholder={t("onboarding.step2.argsPlaceholder")}
                          value={args}
                  ...
                  {(adapterType === "http" || adapterType === "openclaw_gateway") && (
                    <div>
                      <label className="text-xs text-muted-foreground mb-1 block">
                        {adapterType === "openclaw_gateway" ? t("onboarding.step2.gatewayUrl") : t("onboarding.step2.webhookUrl")}
                      </label>
                      <input
                        className="w-full rounded-md border border-border bg-transparent px-3 py-2 text-sm font-mono outline-none focus:ring-1 focus:ring-ring placeholder:text-muted-foreground/50"
              ...
              {step === 3 && (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground mb-1 block">
                      {t("onboarding.step3.descriptionLabel")}
                    </label>
                    <textarea
                      ref={textareaRef}
                  ...
                  <div className="border border-border divide-y divide-border">
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("onboarding.step4.company")}</p>
                      </div>
                    ...
                    <div className="flex items-center gap-3 px-3 py-2.5">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-muted-foreground">{t("onboarding.step4.task")}</p>
                      </div>
                      <Check className="h-4 w-4 text-green-500 shrink-0" />
                    </div>
                  </div>
