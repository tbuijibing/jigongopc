...
import { PROJECT_COLORS, isUuidLike } from "@Jigongai/shared";
...
function ProjectIssuesList({ projectId, companyId }: { projectId: string; companyId: string }) {
  ...
  return (
    <IssuesList
      ...
      projectId={projectId}
      viewStateKey={`Jigong:project-view:${projectId}`}
    ...
    <div className="space-y-6">
      <div className="flex items-start gap-3">
        ...
        <Button
          ...
          title={t("projectDetail.properties")}
        >
        ...
        <Button
          ...
          title={t("projectDetail.showProperties")}
        >
          <SlidersHorizontal className="h-4 w-4" />
        </Button>
      </div>
      ...
      <Sheet open={mobilePropsOpen} onOpenChange={setMobilePropsOpen}>
        <SheetContent side="bottom" className="max-h-[85dvh] pb-[env(safe-area-inset-bottom)]">
          <SheetHeader>
            <SheetTitle className="text-sm">{t("projectDetail.properties")}</SheetTitle>
          </SheetHeader>
