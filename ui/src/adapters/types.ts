...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@Jigongai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@Jigongai/adapter-utils").TranscriptEntry[];
