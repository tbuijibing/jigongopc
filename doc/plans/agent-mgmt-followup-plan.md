...
- `skills/Jigong/SKILL.md` and `skills/Jigong/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/Jigong-create-agent/SKILL.md`
