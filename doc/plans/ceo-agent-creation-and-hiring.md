...
- installed adapter list for this JiGong instance
...
## 8. New Skill: `Jigong-create-agent`

Create new skill directory:

- `skills/Jigong-create-agent/SKILL.md`
...
Also update `skills/Jigong/SKILL.md` to reference this skill for hiring workflows.
...
- `Jigong-create-agent` skill + docs updates
