...
This document describes how `@Jigongai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into JiGong logs/transcript parsing
