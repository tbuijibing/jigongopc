...
export const DEPENDENCY_TYPES = ["blocks", "required_by", "relates_to"] as const;
export type DependencyType = (typeof DEPENDENCY_TYPES)[number];

export const MEMORY_LAYERS = ["agent", "project", "task"] as const;
export type MemoryLayer = (typeof MEMORY_LAYERS)[number];

export const MEMORY_TYPES = ["fact", "preference", "learning", "context"] as const;
export type MemoryType = (typeof MEMORY_TYPES)[number];

export const TOOL_TYPES = ["mcp", "api", "shell", "builtin"] as const;
...
export const INSTALL_TYPES = ["manual", "auto_role", "self_install"] as const;
export type InstallType = (typeof INSTALL_TYPES)[number];

export const WATCHER_TYPES = ["agent", "user"] as const;
