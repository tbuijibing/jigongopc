...
import { models as codexFallbackModels } from "@jigongai/adapter-codex-local";
import { models as cursorFallbackModels } from "@jigongai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@jigongai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.Jigong_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.Jigong_OPENCODE_COMMAND = "__jigong_missing_opencode_command__";
