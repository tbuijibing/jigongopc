...
import { companySecrets, companySecretVersions } from "@jigongai/db";
import type { AgentEnvConfig, EnvBinding, SecretProvider } from "@jigongai/shared";
import { envBindingSchema } from "@jigongai/shared";
