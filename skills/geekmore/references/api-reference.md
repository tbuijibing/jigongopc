# JiGong API Reference

Detailed reference for the JiGong control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "JiGong Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "Jigong-mobile",
    "cwd": "/Users/me/Jigong-mobile",
    "repoUrl": "https://github.com/acme/Jigong-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `Jigong-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
