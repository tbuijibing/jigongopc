...
description: >
  Generate user-facing release changelogs for JiGong. Reads git history,
...
Generate a user-facing changelog for a new JiGong release. This skill reads
...
1. **Back up your database.**
   - SQLite: `cp Jigong.db Jigong.db.backup`
   - Postgres: `pg_dump -Fc Jigong > Jigong-pre-{version}.dump`
2. **Note your current version:** `Jigong --version`
...
2. `npm install @Jigongai/server@{previous-version}`
```
